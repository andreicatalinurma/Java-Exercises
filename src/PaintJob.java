...
//        System.out.println(getBucketCount(3.26, 0.75));
    ...
    public static int getBucketCount( double width, double height, double areaPerBuckets, int extraBuckets){
        ...
        bucketsToBuy = Math.ceil((areaToPaint - areaPerBuckets * extraBuckets) / areaPerBuckets);
        /*if(bucketsToBuy < 0){
            bucketsToBuy = 0;
        }*/
    ...
    public static int getBucketCount( double width, double height, double areaPerBuckets){
        ...
        double areaToPaint = width * height;
        bucketsToBuy = Math.ceil(areaToPaint / areaPerBuckets);
    ...
    public static int getBucketCount( double area, double areaPerBuckets){
        ...
        bucketsToBuy = Math.ceil(area / areaPerBuckets);
